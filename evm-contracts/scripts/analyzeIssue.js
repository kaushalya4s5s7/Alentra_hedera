...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.log("📊 Stats:", stats[0].toString(), "payments,", ethers.formatEther(stats[1]), "HBAR volume");
    } catch (viewError) {
    ...
    try {
      ...
      console.log("💰 New balance:", ethers.formatEther(newBalance), "HBAR");
    ...
    try {
      ...
      console.log("💰 Minimal balance:", ethers.formatEther(minBalance), "HBAR");
